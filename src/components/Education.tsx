  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="font-medium w-full md:text-sm underline underline-offset-2">Relevant courses:</p>
        <ul className="list-disc list-inside md:text-sm">
          {courses.map((course, i) => (
            <li key={`course-${i}`}>{course}</li>
          ))}
        </ul>
        <p className="font-medium w-full md:text-sm underline underline-offset-2">Achievements:</p>
        <ul className="list-disc list-inside md:text-sm">
