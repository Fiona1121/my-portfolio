...
const HireMe = (props: Props) => {
  return (
    <div className="fixed right-4 bottom-4 flex items-center justify-center overflow-hidden opacity-50 hover:opacity-100 transition-all duration-300 ease-in-out">
